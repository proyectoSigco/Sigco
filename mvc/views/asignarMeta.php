              ...
              <section class="content">
                  <div class="row">
                      ...
                      alert-dismissable">
                          ...
                          ?>
                    <form id="defaultForm" action="../controllers/controladorMetasUsuarios.php" method="post">

                      <div class="box box-default">
                                  <div class="box-header with-border">
                                      <h3 class="box-title">Asignar Meta</h3>
                                  </div>
                                  <!-- /.box-header -->
                                  <div class="box-body">
                                          ...
                                          <div class="form-group">
                                              <p>
                                                  Por favor diligencie el siguiente formulario para Asignarle metas a un empleado.<br><br>
                          ...
                          <div class="box box-default">
                           ...
                           <div class="box-body">
                               ...
                               <div class="form-group">
                                   ...
                                   <select class="form-control" name="cedula" id="cedula">
                                       ...
                                       foreach ($lista as $recorrer ) { ?>
                                        <option value="<?php echo $recorrer['cc'] ?>"><?php echo $recorrer['cc'] ?></option>
                                       <?php
                                       }
                               ...
                               <div class="form-group">
                                   <label for="meta">Seleccionar Meta*</label>
                                   <select class="form-control" name="meta" id="meta">
                                       <option value="">Seleccionar</option>
                                       <?php
                                        $metas=$facade->listarMetas();foreach ($metas as $mostrar ) { ?>
                                           <option value="<?php echo $mostrar['IdMeta'] ?>"><?php echo 'Fecha Inicio '.$mostrar['FechaInicio'] ?></option>
                                           <?php
                                       }
