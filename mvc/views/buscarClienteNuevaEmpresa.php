                    ...
                    <div class="col-md-10">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Añadir empresa a un cliente registrado</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <p>
                                    Digite la cédula del cliente para añadirle una empresa(*).
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Cédula del cliente</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">

                                <form role="form" id="formValidacion" action="../controllers/ClientesController.php?controlar=buscarCedula" method="post">

                                    <div class="form-group">
                                        <label for="cedulaPersona" >Número de cédula*</label>
                                        <div class="input-group input-group-sm margin">
                                            <input type="text" name="cedulaPersona" id="cedulaPersona" class="form-control"
                                                <?php if(isset($_GET['cedulaPersona'])){echo 'value="'.$_GET['cedulaPersona'].'"';
                                                }else{echo 'placeholder="5104321"';};?> required tabindex="1" autofocus>
                    <span class="input-group-btn">
                      <button class="btn btn-info btn-flat" type="submit" tabindex="2"><i class="fa fa-search"></i>
                          Añadir empresa a cliente</button>
                    </span>
                                        </div><!-- /input-group -->
                                    </div>
                                </form>
                        ...
                        <?php
                        if (isset($_GET['encontrados'])) {
                            ?>
                            <div class="alert alert-warning alert-dismissable ">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="fa fa-warning">   </i>
                                    Resultado del proceso:</h4>
                                <p>
                                    No hay coincidencias de búsqueda para la cédula No. <?php echo $_GET['cedulaPersona'] ?>
                                </p>
                            </div>
