...
<!--  <link rel="stylesheet" href="/resources/demos/style.css">-->
 ...
 <div class="content-wrapper">
              ...
              <section class="content">
                  ...
                  ?>
                    <form id="defaultForm" action="../controllers/controladorCotizacion.php?idcliente=<?php echo $cliente?>" method="post">
                          ...
                          <div class="box box-default">
                           ...
                           <div class="box-body">
                               ...
                               <div class="form-group">
                                   ...
                                   <input class="form-control" name="observaciones" id="cantidad" type="text" value="<?php echo $cliente?>" readonly>
                               </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" name="idproducto" id="idproducto">
                                              ...
                                              foreach ($listado as $clientes ) { ?>
                                                  <option value="<?php echo $clientes['IdProducto']?>"><?php echo $clientes['NombreProducto']?></option>
                                                  <?php
                                              }
                                              ?>
                                          </select>
