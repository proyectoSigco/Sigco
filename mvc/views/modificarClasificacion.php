...
<div class="wrapper">
    ...
    if (isset($_GET['IdClasificacion'])) {
        $clasificacionFac = new ClasificacionesFacade();
        $clasificacion = $clasificacionFac->obtenerClasificacion($_GET['IdClasificacion']);
        ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Modificar clasificación</li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form
                            action="../controllers/ClasificacionesController.php?controlar=modificar&IdClasificacion=<?php echo $_GET['IdClasificacion']; ?>"
                            method="post" class="validacion" id="formValidacion">

                            <!-- general form elements disabled -->
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Modificar clasificación</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <p>
                                            Por favor diligencie el siguiente formulario para modificar una
                                            clasificación.<br><br>
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="IdClasificacion">Id. de la clasificación (único)</label>
                                        <input type="text" name="IdClasificacion" id="IdClasificacion" class="form-control"
                                               value="<?php echo $clasificacion['IdClasificacion']; ?>" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="NombreClasificacion">Nombre de la IdClasificacion*</label>
                                        <input type="text" name="NombreClasificacion" id="NombreClasificacion" class="form-control"
                                               value="<?php echo $clasificacion['NombreClasificacion']; ?>" autofocus required
                                               tabindex="1"/>
                                    </div>
