                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="codigoProducto"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ivaProducto" id="cargo">
                                            ...
                                            foreach ($producto->obtenerImpuestosProducto() as $iterator) { ?>
                                                <option value="<?php echo $iterator['IdIva'];
                                                if ($p['IdIva'] == $iterator['IdIva']) {
                                                    echo 'selected';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="valorProducto"
                                               value="<?php echo $p['ValorBase'] ?>" id="pass1" type="number" maxlength="20"
                                               required title="Este campo es requerido">

                                    </div>
                                    <div class="form-group">
                                        <img src="<?php echo $p['rutaImagen'] ?>" class="img-responsive"
                                             alt="Responsive image">
                                    </div>
                                    <div class="form-group">
                                        <label for="imagen">Imágen</label>

                                        <input name="ImagenProducto" id="imagen" type="file" multiple=true class="file"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="presentacionProducto" id="cargo">
                                            ...
                                            foreach ($Productos as $iterator) { ?>
                                                <option value="<?php echo $iterator['IdPresentacion'];
                                                if ($iterator['IdPresentacion'] == $p['IdPresentacion']) {
                                                    echo 'selected';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="categoriaProducto" id="cargo">
                                            ...
                                            foreach ($Productos as $iterator) { ?>
                                                ...
                                                if ($iterator['IdCategoria'] == $p['IdCategoria']) {
                                                    echo 'selected';
