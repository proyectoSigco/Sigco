                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Buscar Metas</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <p>
                                    Use las siguientes opciones para realizar la búsqueda de una meta.
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <form role="form" action="../controllers/controladorMetasUsuarios.php?buscar=true" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                                            <option value="Metas.Tipo" selected>Tipo (Ej: Ventas)</option>
                                            <option value="Metas.CantidadValor" >Valor a cumplir (Ej: 500000)</option>
                                            <option value="Metas.FechaInicio" >Fecha Inicio (Ej: 2015-02-02) </option>
                                            <option value="Metas.FechaFin" >Fecha Fin (Ej: 2015-09-30)</option>
                                        </select>
                                    </div>
                    ...
                    <span class="input-group-btn">
                      <button class="btn btn-info btn-flat" type="submit" tabindex="4">Buscar Meta</button>
                    </span>
                                    </div><!-- /input-group -->
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo $respuesta['IdMeta']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['Tipo']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['CantidadValor']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['FechaInicio']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['FechaFin']; ?>
                                                </td>

                                                <td>
                                                    <a href="modificarMeta.php?id=<?php echo $respuesta['IdMeta'] ?>">
                                    ...
                                    <div class="box-footer">
                                        <form role="form" action="../utilities/exportarMetas.php?" method="post">
                        ...
                        if (!isset($_GET['todos'])){ ?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    <form action="../controllers/controladorMetasUsuarios.php?listar=todos" method="post">
