                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Buscar ordenes de compra</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <p>
                                    Use las siguientes opciones para realizar la búsqueda de una orden de compra.
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <form role="form" action="../controllers/ControladorOrdenCompra.php?buscar=true" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                                            <option value="OrdenesDeCompra.EstadoOrdenCompra" selected>Estado Orden</option>
                                            <option value="Clientes.RazonSocial" >Nombre Empresa</option>
                                            <option value="OrdenesDeCompra.IdOrden" >ID Orden</option>
                                        </select>
                                    </div>
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo $respuesta['IdOrden'] ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['EstadoOrdenCompra']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['ValorTotalCotizacion']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['GranTotal']; ?>
                                                </td>
                                                <td>
