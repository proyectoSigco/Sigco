            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <p>
                                    Use las siguientes opciones para realizar la búsqueda de una cotización.
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <form role="form" action="../controllers/controladorCotizacion.php?buscar=true" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                                            <option value="Cotizaciones.EstadoCotización" selected>Estado Cotización</option>
                                            <option value="Clientes.RazonSocial" >Nombre Empresa</option>
                    ...
                    <span class="input-group-btn">
                      <button class="btn btn-info btn-flat" type="submit" tabindex="4">Buscar cotización(es)</button>
                    </span>
                                    </div><!-- /input-group -->
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $respuesta['ValorTotalCotizacion']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['FechaCreacionCotizacion']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $respuesta['EstadoCotización']; ?>
                                                </td>
                        ...
                        if (!isset($_GET['todos'])){ ?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    <form action="../controllers/controladorCotizacion.php?listar=todos" method="post">
