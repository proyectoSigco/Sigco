...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Detalles cotización</title>
            ...
            <section class="invoice">
                ...
                <div class="row invoice-info">
                    <div class="col-sm-4 invoice-col">
                        Vendedor
                        <address>
                            <strong><?php echo $_SESSION['datosLogin']['Nombres'].' '.$_SESSION['datosLogin']['Apellidos']?></strong><br>
                            Cra 125 # 12-14<br>
                            Bogotá, Colombia<br>
                            Télefono: +1 4560022<br/>
                            Email: ventas@sigco.com
                        </address>
                    </div><!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                        Comprador
                        <address>
                            <strong><?php echo $resultados[0]['RazonSocial']?></strong><br>
                            <?php echo $resultados[0]['Direccion']?><br>
                            <?php echo $resultados[0]['NombreLugar']?><br>
                            Télefono:<?php echo $resultados[0]['Telefono']?><br/>
                            Email: <?php echo $resultados[0]['EmailCliente']?>
                        </address>
                    </div><!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                        <b>Cotización: #<?php echo $resultados[0]['IdCotizacion']?></b><br/>
                        <br/>
                        <b>Fecha:</b> <?php echo $resultados[0]['FechaCreacionCotizacion']?><br/>
                        <b>NIT Cliente:</b> <?php echo $resultados[0]['Nit']?><br>
                        <b>Estado:</b> <?php echo $resultados[0]['EstadoCotización']?>
                    ...
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            foreach ($resultados as $datos) {
                                ...
                                $totaliva=$totaliva+$datos['ValorIva'];
                                ?>
                                <tr>
                                    <td><?php echo $datos['CantidadProductos'] ?></td>
                                    <td><?php echo $datos['NombreProducto'] ?></td>
                                    <td><?php echo $datos['ValorBase'] ?></td>
                                    <td><?php echo $datos['ValorIva'] ?></td>
                                    <td><?php echo $datos['TotalDetalle'] ?></td>
                                </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <p class="lead">Fecha actual: <?php echo date("j") . " /" . date("m") . " /" . date("Y");
                            ?></p>
                ...
                <div class="row no-print">
                    <div class="col-xs-12">
                        ...
                        <button class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Enviar al correo</button>
