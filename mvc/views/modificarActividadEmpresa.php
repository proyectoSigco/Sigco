...
<div class="wrapper">
    ...
    if (isset($_GET['IdActividad'])) {
        $actividadesFac = new ActividadesEmpresasFacade();
        $actividad = $actividadesFac->obtenerActividadEmpresa($_GET['IdActividad']);
        ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Actividades de empresas</a></li>
                    <li class="active">Modificar Actividades de empresa</li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form
                            action="../controllers/ActividadesEmpresasController.php?controlar=modificar&IdActividad=<?php echo $_GET['IdActividad']; ?>"
                            method="post" class="validacion" id="formValidacion">

                            <!-- general form elements disabled -->
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Modificar Actividades de empresas</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <p>
                                            Por favor diligencie el siguiente formulario para
                                            modificar una actividad de empresa.<br><br>
                            ...
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Información de la actividades</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="IdActividad">Id. Actividad (único)</label>
                                        <input type="text" name="IdActividad" id="IdActividad" class="form-control"
                                               value="<?php echo $actividad['IdActividad']; ?>" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="NombreActividad">Nombre de la actividad*</label>
                                        <input type="text" name="NombreActividad" id="NombreActividad" class="form-control"
                                               value="<?php echo $actividad['NombreActividad']; ?>" autofocus required
                                               tabindex="1"/>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            <input class="minimal-red" type="checkbox" name="PagaIva" id="PagaIva"
                                                <?php if($actividad['PagaIva']=="Si"){echo ' checked ';}; ?>>
                                            ¿Paga IVA?
                                        </label>
                                    </div>
                                    <div class="box-footer">
                                        <input type="button" class="btn btn-warning" tabindex="16"
                                               onclick="location.href='buscarActividadesEmpresas.php'" value="Cancelar"/>
