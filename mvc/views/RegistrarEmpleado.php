                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="celular" id="celular" type="text" maxlength="20" placeholder="3102344444">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" class="btn btn-success pull-right" tabindex="14"
                                                value="guardar" name=" guardar" id="guardar">Registrar empleado
                                        </button>
                                    </div>
