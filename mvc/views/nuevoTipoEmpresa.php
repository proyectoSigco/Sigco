    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Tipos empresas</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                <li><a href="#">Tipos empresas</a></li>
                <li class="active">Nuevos Tipos empresas</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- right column -->
                <div class="col-md-10">
                    <form action="../controllers/TiposEmpresasController.php?controlar=crear"
                          method="post" class="validacion" id="formValidacion">

                        <!-- general form elements disabled -->
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <h3 class="box-title">Nuevos Tipos empresas</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <!-- text input -->
                                <div class="form-group">
                                    <p>
                                        Por favor diligencie el siguiente formulario para registrar
                                        un nuevo tipos de empresas.<br><br>
                        ...
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <h3 class="box-title">Información del tipo de empresa</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="form-group" id="unicoNit">
                                    <label for="IdTipo" >Id. tipo de empresa (Automático)</label>
                                    <input type="text" name="IdTipo" id="IdTipo" class="form-control"
                                           placeholder="Automático" readonly disabled/>
                                </div>
                                <div class="form-group">
                                    <label for="NombreTipo">Nombre tipo de empresa*</label>
                                    <input type="text" name="NombreTipo" id="NombreTipo" class="form-control"
                                           placeholder="Sociedad anónima" required autofocus tabindex="1"/>
                                </div>
                                <div class="box-footer">
                                    <input type="button" class="btn btn-warning" tabindex="16"
                                           onclick="location.href='buscarTiposEmpresas.php'" value="Cancelar"/>
