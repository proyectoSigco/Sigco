                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        ?>
                        <form id="defaultForm" action="../controllers/controladorUsuario.php?modificar=true" method="post">
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <input name="idpersona" type="text" value="<?php echo $persona?>" hidden>
                                        <label for="cc">Documento*</label>
                                        <input class="form-control" name="documento2" id="cc" type="text" value="<?php echo $empleado['CedulaPersona']?>" required>
                                    </div>
                                    <div class="form-group">
