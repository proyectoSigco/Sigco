    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Actividades de empresas</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- right column -->
                <div class="col-md-10">
                    <form action="../controllers/ActividadesEmpresasController.php?controlar=crear"
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                <div class="form-group" id="unicoNit">
                                    <label for="IdActividad" >Id. de la actividad (Automático)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="NombreActividad" id="NombreActividad" class="form-control"
                                           placeholder="Construcción" required autofocus tabindex="1"/>
                                </div>
                                <div class="form-group">
                                    <label>
                                        <input class="minimal-red" type="checkbox" name="PagaIva" id="PagaIva" checked>
                                        ¿Paga IVA?
                                    </label>
                                </div>
