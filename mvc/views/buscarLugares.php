        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Buscar lugares</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <p>
                                Use las siguientes opciones para realizar la búsqueda de un lugar.
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" action="../controllers/LugaresController.php?controlar=buscar" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                                        <option value="lugares.IdLugar"
                                            <?php if(isset($_GET['criterio'])&&$_GET['criterio']=='lugares.IdLugar'){echo 'selected';} ?>
                                            >Id. del lugar (Ej. 14)</option>
                                        <option value="lugares.NombreLugar"
                                            <?php if(isset($_GET['criterio'])&&$_GET['criterio']=='lugares.NombreLugar'){echo 'selected';} ?>
                                            >Nombre del lugar (Ej. Bogotá)</option>
                                    </select>
                                </div>
                                ...
                                <div class="input-group input-group-sm margin">
                                    ...
                                    <input type="text" name="busqueda" class="form-control"
                                        ...
                                        }elseif(isset($_GET['todos'])&&$_GET['todos']=='todos'){echo 'placeholder=" Número Id. del lugar | Nombre del lugar "';
                                        }else{echo 'placeholder=" Número Id. del lugar | Nombre del lugar "';}
                                        ?>
                                           required tabindex="3">
					<span class="input-group-btn">
					  <button class="btn btn-info btn-flat" type="submit" tabindex="4"><i class="fa fa-search">     </i>     Buscar lugares</button>
					</span>
                                </div><!-- /input-group -->
                    ...
                    if(isset($_GET['encontrados'])&&isset($_SESSION['consulta'])) {
                        ...
                        if ($_GET['encontrados'] == 'true') {
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="modificarLugar.php?IdLugar=<?php echo $respuesta['IdLugar']; ?>">
                                ...
                                <div class="box-footer">
                                    <form role="form" action="../utilities/exportarLugares.php?busqueda=<?php
                    ...
                    if (!isset($_GET['todos'])){ ?>
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <form action="../controllers/LugaresController.php?controlar=todos" method="post">
