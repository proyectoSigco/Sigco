...
<head>
    <meta charset="UTF-8">
    <title>Buscar clasificaciones</title>
                ...
                <div class="col-md-10">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" action="../controllers/ClasificacionesController.php?controlar=buscar" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                                        <option value="clasificaciones.IdClasificacion"
                                            <?php if(isset($_GET['criterio'])&&$_GET['criterio']=='clasificaciones.IdClasificacion'){echo 'selected';} ?>
                                            >Id. de la clasificación (Ej. 4)</option>
                                        <option value="clasificaciones.NombreClasificacion"
                                            <?php if(isset($_GET['criterio'])&&$_GET['criterio']=='clasificaciones.NombreClasificacion'){echo 'selected';} ?>
                                            >Nombre de la clasificación (Ej. Frecuente)</option>
                                    </select>
                                </div>
                                ...
                                <div class="input-group input-group-sm margin">
                                    ...
                                    <input type="text" name="busqueda" class="form-control"
                                        ...
                                        }elseif(isset($_GET['todos'])&&$_GET['todos']=='todos'){echo 'placeholder=" Número Id. de la clasificación | Nombre de la clasificación "';
                                        }else{echo 'placeholder=" Número Id. de la clasificación | Nombre de la clasificación "';}
                                        ?>
                                           required tabindex="3">
					<span class="input-group-btn">
					  <button class="btn btn-info btn-flat" type="submit" tabindex="4"><i class="fa fa-search">     </i>     Buscar clasificaciones</button>
					</span>
                                </div><!-- /input-group -->
                    ...
                    if(isset($_GET['encontrados'])&&isset($_SESSION['consulta'])) {
                        ...
                        if ($_GET['encontrados'] == 'true') {
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="modificarClasificacion.php?IdClasificacion=<?php echo $respuesta['IdClasificacion']; ?>">
                                ...
                                <div class="box-footer">
                                    <form role="form" action="../utilities/exportarClasificaciones.php?busqueda=<?php
                    ...
                    if (!isset($_GET['todos'])){ ?>
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <form action="../controllers/ClasificacionesController.php?controlar=todos" method="post">
