      ...
      <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <?php
                    require'../facades/FacadePermisos.php';
                    $facade=new FacadePermisos();
                    $total=$facade->listarPermisos();
                    ?>
                    <!-- right column -->
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        ?>
                        <form id="defaultForm" action="../controllers/ControladorPermisosRoles.php?cantidad=<?php echo $_SESSION['cantidad']?>" method="post">
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <p>
                                            Por favor diligencie el siguiente formulario para Asignarle el rol a un empleado.<br><br>
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="idrol" id="idrol" type="text" value="<?php echo $_GET['id']?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="nombrerol">Nombre Rol*</label>
                                        <input class="form-control" name="nombrerol" id="nombrerol" type="text" value="<?php echo $_GET['name']?>" readonly>
                                    </div>



                                    <div class="form-group">
                                        <label for="cedula">Seleccionar Permisos*</label> <br>
                                        <?php
                                        foreach ($total as $recorrer) {
                                            ?>

                                            <input type="checkbox" class="minimal" name="<?php echo $recorrer['IdPermiso']?>" value="<?php echo $recorrer['IdPermiso']?>"><?php echo $recorrer['NombrePagina']?><br>
                                            <?php
                                        }
