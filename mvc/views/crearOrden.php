                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      alert-dismissable">
                        ...
                        ?>
                        <form id="defaultForm" action="../controllers/ControladorOrdenCompra.php" method="post">
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="descuento" id="descuento" type="text" value="0" onchange="calcu2()">
                                    </div>

                                    <script type="text/javascript">
                                        function calcu2(){
                                            var v1 = document.getElementById('valorcoti').value;
                                            var v2= parseFloat(v1);
                                            var v4= document.getElementById('descuento').value;
                                            var v5= parseFloat(v4);
                                            var v3= v2-v5;
                                            var test= document.getElementById('total').value=v3;
                                        }
                                    </script>
                                    <div class="form-group">
