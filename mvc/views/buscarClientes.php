                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../controllers/ClientesController.php?cedula=<?php echo $respuesta['CedulaPersona'].'&estado='.$respuesta['EstadoPersona'].'&controlar=cambiarEstado'; ?>" onclick="return confirmar();">
                                                  <span
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../controllers/ClientesController.php?IdPersona=<?php echo $respuesta['IdPersona'].'&controlar=contrasenia'; ?>" onclick="return contrasenia();">
                                                        <button class="btn btn-xs bg-gray-active">
