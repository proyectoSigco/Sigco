                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="finicio" id="finicio" type="text" placeholder="2015-01-01" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="ffinal">Fecha Final*</label>
                                        <input class="form-control" name="ffinal" id="ffinal" type="text" maxlength="20" placeholder="2015-01-01">
